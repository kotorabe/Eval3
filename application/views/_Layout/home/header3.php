...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="<?= base_url('Dashboard/Red');?>">
            ...
            <li class="nav-item">
                ...
                <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="<?= base_url('Patient/Red_Add');?>">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-journal-arrow-down"></i><span>Type d'actes</span><i class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="<?= base_url('Acte/RedList');?>">
                            <i class="bi bi-circle"></i><span>Voir la liste</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?= base_url('Acte/Red_Add');?>">
                            <i class="bi bi-circle"></i><span>Ajouter</span>
                        </a>
                    </li>
                </ul>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed " data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-journal-arrow-up"></i><span>Dépense</span><i class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="<?= base_url('Depense/Red_Add');?>">
                            <i class="bi bi-circle"></i><span>Ajouter</span>
                        </a>
                    </li>
                </ul>
            ...
            <li class="nav-item">
                ...
                <ul id="icons-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="<?= base_url('Communication/Red_Add');?>">
                            <i class="bi bi-circle"></i><span>Ajouter</span>
                        </a>
                    </li>
                    <li>
            ...
            <li class="nav-item">
                ...
                <ul id="icon-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="<?= base_url('Transport/Red_Add');?>">
                            <i class="bi bi-circle"></i><span>Ajouter</span>
                        </a>
                    </li>
                    <li>
