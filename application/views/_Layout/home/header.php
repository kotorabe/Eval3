...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand" href="#">Hopital Ntsika</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="form-inline my-2 my-lg-0">
                <?php if (!empty($this->session->userdata('USER_ID')) && $this->session->userdata('USER_ID') != '') { ?>
                <!-- User isLogin -->
                ...
                <a href="<?= base_url('Admin/login') ?>" class="btn btn-success my-2 my-sm-0">Admin</a>
                <?php } ?>
            </div>
        </div>
    </nav>
