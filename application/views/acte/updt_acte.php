    ...
    <section class="section">
        ...
        <div class="row">
            ...
            <div class="col-7">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Modif d'Acte</h5>
                        <form action="<?= base_url('Acte/Update');?>" method="post">
                            <div class="row mb-10">
                            ...
                            <div class="row mb-10">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="code" class="form-control" id="inputText" placeholder="<?= $code; ?>">
                                </div>
                            </div> <br>
                            <div class="row mb-10">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">Budget:</label>
                                <div class="col-sm-10">
                                    <input type="number" name="budget" class="form-control" id="inputText"">
                                </div>
                            </div> <br>
