                        ...
                        <table class="table">
                            ...
                            <tbody class="text-center">
                                ...
                                <tr>
                                    ...
                                    <td scope="row"><?= round(($r['tarif'] * 100)/$bdg_r) ?> %</td>
                                </tr>
                                <?php } ?>
                                <tr>
                                    ...
                                    <?php if($sum_br != 0){ ?>
                                    <td scope="row"><?= round(($sum_r * 100)/($sum_br/12)) ?> %</td>
                                    <?php }else{ ?>
                                    <td scope="row">0 %</td>
                                    <?php } ?>
                                </tr>
                        ...
                        <table class="table">
                            ...
                            <tbody class="text-center">
                                ...
                                <tr>
                                    ...
                                    <td scope="row"><?= round(($d['tarif'] * 100)/$bdg_d)  ?> %</td>
                                </tr>
                                <?php } ?>
                                <tr>
                                    <th scope="row">TOTAL :</th>
                                    ...
                                    <?php if($sum_bd != 0){ ?>
                                    <td scope="row"><?= round(($sum_d * 100)/($sum_bd/12)) ?> %</td>
                                    <?php }else{ ?>
                                    <td scope="row">0 %</td>
                                    <?php } ?>
                                </tr>
                        ...
                        <table class="table">
                            ...
                            <tbody class="text-center">
                                ...
                                <tr>
                                    ...
                                    <?php if($sum_bd != 0){ ?>
                                        <td scope="row"><?= round(($total_l * 100)/$total_r) ?> %</td>
                                    <?php }else{ ?>
                                    <td scope="row">0 %</td>
                                    <?php } ?>
                                </tr>
